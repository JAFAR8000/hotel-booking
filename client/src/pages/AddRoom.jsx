...
export default function AddRoom() {
  ...
  return (
    ...
    accurate room detail, pricing and amenities, to enhnace the user booking experience "
      ...
      <div className="w-full flex max-sm:flex-col sm:gap-4 mt-4">
        <div className="flex-1 max-w-48">
          ...
          <select
            ...
            className="border opacity-70 border-gray-300 mt-1 rounded p-2 w-ful"
          >
      ...
      <button className="bg-primary text-white px-8 py-2 rounded mt- cursor-pointer">Add Room</button>
    </form>
  );
}
